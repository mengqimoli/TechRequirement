...
public class XGTableServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) 
	    ...
	    System.out.println(strOrgNeedNum);
	    ...
	    if(request.getParameter("OrgSubject3") != "")
	    {
	    ...
	    else if(request.getParameter("OrgSubject2") != "")
	    {
	    	strOrgSubject1 = request.getParameter("OrgSubject1");//基础研究(学科分类1)
	    	strOrgSubject2 = request.getParameter("OrgSubject2");//基础研究(学科分类2)
	    	strOrgSubject = strOrgSubject1 + "," + strOrgSubject2;//基础研究(学科分类)
	    }
	    else if(request.getParameter("OrgSubject1") != "")
	    {
	    	strOrgSubject1 = request.getParameter("OrgSubject1");//基础研究(学科分类1)
	    ...
	    if(request.getParameter("OrgTechWork1") != "")
	    {
		...
		String strUserName=(String)request.getSession().getAttribute("user_in_session");//*****************得到session中的用户名
		...
		*/
		...
		strSql = "update OrgInformation set OrgPutunder='"+strOrgPutunder+"',OrgAddress='"+strOrgAddress+"',OrgArea='"+strOrgArea+
				"',OrgURL='"+strOrgURL+"',OrgEmail='"+strOrgEmail+"',OrgLaw='"+strOrgLaw+"',OrgContacts='"+strOrgContacts+
				"',OrgFixedPhone='"+strOrgFixedPhone+"',OrgPhone='"+strOrgPhone+"',OrgPortraiture='"+strOrgPortraiture+
				"',OrgAttribute='"+strOrgAttribute+"',OrgIntroduction='"+strOrgIntroduction+"',OrgTechNeed='"+strOrgTechNeed+
				"',OrgNeedTime='"+strOrgNeedTime+"',OrgNeedTime1='"+strOrgNeedTime1+"',OrgScienceNeed='"+strOrgScienceNeed+
				"',OrgScienceNeed1='"+strOrgScienceNeed1+"',OrgScienceNeed2='"+strOrgScienceNeed2+
				"',OrgKey='"+strOrgKey+"',OrgResearchType='"+strOrgResearchType+"',OrgSubject='"+strOrgSubject+
				"',OrgTechArea='"+strOrgTechArea+"',OrgTechWork='"+strOrgTechWork+"',OrgCooperation='"+strOrgCooperation+
				"',OrgCooperUnit='"+strOrgCooperUnit+"',OrgAllMoney='"+strOrgAllMoney+"' where OrgNeedNum = '"+strOrgNeedNum+"'";
		...
		try{
			if(i!=1)
			{
		        ...
		        request.setAttribute("msg","需求征集表修改有误!");
		        RequestDispatcher requestDispatcher = request.getRequestDispatcher("/templete/xgtable.jsp");
			...
			out.print("<script>alert('修改成功!');window.location.href='templete/mywj.jsp'</script>");
		}catch(Exception e){
			e.printStackTrace();
