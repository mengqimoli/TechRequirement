...
<script type="text/javascript">
	...
	function Check1()
	{
		var juese = document.getElementById("xzjs"); 
		if(juese.value == ""){
			alert("请输入角色");
			return false;
		}
...
<body>
	<form action="xzjsServlet" method="post" name="jsglForm" id="jsglForm">
		<br />
		<div style="font-size: 25px; text-align: center;">新增角色</div>
		<br />
		<div style="text-align: center;">
			输入角色名: <input type="text" name="xzjs" id="xzjs" style="width: 250px;" />
