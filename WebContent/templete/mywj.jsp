...
%>
	...
	<form action="templete/mywj1.jsp" name="mywjForm" method="post">
	...
	<table style="width: 1100px;">
		...
		<tr>
			<td colspan="7" align="center">共<span class="fenye"><%=intRowCount%></span>条,
				...
				href='templete/mywj.jsp?page=<%=intPage-1%>'><span class="fenye">上一页</span></a>
				<span class="fenye"> <%
	                 	for (int j = 1; j <= intPageCount; j++) {
	                 		out.print("&nbsp;<a href='templete/mywj.jsp?page="+j+"'>"+j+"</a>");
	                 	}
	                 %>
			</span> <a href='templete/mywj.jsp?page=<%=intPage+1%>'><span
