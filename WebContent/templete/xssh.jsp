...
<body>
	...
	String sql="select OrgInformation.*,XSSH.* from OrgInformation,XSSH where OrgInformation.OrgNeedNum = XSSH.OrgNeedNum and XSSH.OrgXSSH = '未审核'";
	...
	<table style="width: 1100px;">
			...
			if(rs.getRow()!=0)
			{
				while(i < intPageSize && !rs.isAfterLast())
				{
					out.println(
							...
							"<td>"+"<a href='sh/xstable.jsp?OrgNeedNum="+rs.getString("OrgNeedNum")+"' target='_self'>"+"查看"+"</a>"+
							"</td>"+
							"</tr>"
							);
					rs.next();
		...
		<tr>
			<td colspan="11" align="center">共<span class="fenye"><%=intRowCount%></span>条,
				...
				href='templete/xssh.jsp?page=<%=intPage-1%>'><span class="fenye">上一页</span></a>
				<span class="fenye"> <%
	                 	for (int j = 1; j <= intPageCount; j++) {
	                 		out.print("&nbsp;<a href='templete/xssh.jsp?page="+j+"'>"+j+"</a>");
	                 	}
	                 %>
			</span> <a href='templete/xssh.jsp?page=<%=intPage+1%>'><span
