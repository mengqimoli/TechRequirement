...
<body>
	...
	<form action="templete/tongji1.jsp" name="tongjiForm" method="get">
		<table style="width: 1100px;">
			<tr>
	...
	<table style="width: 1100px;">
		...
		<tr>
			<td colspan="7" align="center">共<span class="fenye"><%=intRowCount%></span>条,
				...
				href='templete/tongji.jsp?page=<%=intPage-1%>'> <span
					class="fenye">上一页</span>
			</a> <span class="fenye"> <%
	                 	for (int j = 1; j <= intPageCount; j++) {
	                 		out.print("&nbsp;<a href='templete/tongji.jsp?page="+j+"'>"+j+"</a>");
	                 	}
	                 %>
			</span> <a href='templete/tongji.jsp?page=<%=intPage+1%>'> <span
