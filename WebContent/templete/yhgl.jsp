...
<body>
	...
	<br />
	<form action="templete/yhgl1.jsp" method="post" name="yhglForm">
		<div style="text-align: center;">
	...
	<table>
		...
		<tr>
			<td colspan="11" align="center">共<span class="fenye"><%=intRowCount%></span>条,
				...
				href='templete/yhgl.jsp?page=<%=intPage-1%>'><span class="fenye">上一页</span></a>
				<span class="fenye"> <%
	                 	for (int j = 1; j <= intPageCount; j++) {
	                 		out.print("&nbsp;<a href='templete/yhgl.jsp?page="+j+"'>"+j+"</a>");
	                 	}
	                 %>
			</span> <a href='templete/yhgl.jsp?page=<%=intPage+1%>'><span
