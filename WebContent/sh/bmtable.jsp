...
<script type="text/javascript">
	...
	function Check1()
	{
		var beizhu = document.getElementById("BMSHText").value;
		if(beizhu.trim()=="")
		{
			alert("请写明不通过的原因!");
			document.getElementById("BMSHText").focus();
			return false;
		}
		else
		{
...
<body>
	...
	<form action="bmshServlet?OrgNeedNum=<%=strOrgNeedNum%>"
		id="bmtableform" name="bmtableform" method="post" target="_self">
		<table>
			<tr>
				<td style="height: 100px; width: 120px;">
					<div>部门审核意见</div>
				</td>
				<td colspan="3"><textarea cols="92" rows="6" id="BMSHText"
						name="BMSHText"></textarea></td>
			</tr>
		</table>
		<br /> <br />
		<div>
